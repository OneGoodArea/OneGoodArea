...
const TOPICS: Topic[] = [
  ...
  },
  {
    ...
    items: [
      { q: "How do I get API access?",            a: "Sign up for the free Sandbox tier and generate an API key from your dashboard. Sandbox includes 250 calls per month at no cost. Upgrade to Starter, Build, Scale, or Growth on the Pricing page when you need more." },
