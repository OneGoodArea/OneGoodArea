...
const CHANGELOG: Month[] = [
  {
    month: "April 2026",
    entries: [
      { type: "feature",     title: "Confidence per dimension.",                      description: "Every score now ships with a confidence value (0.0-1.0) plus a written reason. HIGH for primary fresh data, MEDIUM for partial fallback or older datasets, LOW for proxy fallback, NONE when data is missing. Honest about inferred-not-measured dimensions like Footfall and Rental Yield. Visible on the API response, the report UI, the email, and the PDF." },
      { type: "feature",     title: "Methodology versioning.",                        description: "Every report stamps the engine version that produced it (currently 2.0.0). Public changelog of methodology changes. Lets FCA-regulated buyers pin a version in their model risk register." },
      { type: "feature",     title: "OpenAPI 3.0 spec.",                               description: "Full API contract published at /openapi.json with interactive reference at /docs/api-reference. Procurement-ready, Postman / Insomnia / curl importable. SDK generation one command away." },
      { type: "feature",     title: "Time-series re-scoring infrastructure.",         description: "Monthly re-scoring of top UK postcodes builds a UK area trend dataset that compounds. New report_history table tracks every score with confidence and version stamp." },
      { type: "improvement", title: "Repositioned as infrastructure.",                description: "Front door now leads with deterministic UK location intelligence for lenders, insurers, and PropTech platforms. Same engine, sharper pitch. Methodology page expanded with a confidence rubric, version changelog, and inferred-vs-measured callouts." },
      { type: "improvement", title: "Stripe-parity API hygiene.",                      description: "Retry-After header on 429 responses across the report and widget endpoints. Honest rate-limit feedback for clients implementing backoff." },
      { type: "improvement", title: "Full design overhaul.",                          description: "Every page on Fraunces serif headlines, warm cream surfaces, chartreuse signal accents. Home, reports, dashboard, pricing, docs, blog, and settings rebuilt top to bottom." },
      { type: "improvement", title: "Mobile, properly.",                              description: "Every route works on a phone. Hamburger nav, off-canvas sidebar, tables that collapse sensibly, readable type down to 375px." },
      { type: "improvement", title: "Loading, error, and 404 states in brand.",       description: "Skeleton loaders, error recovery, and not-found pages that match the rest of the site." },
      { type: "improvement", title: "Dark mode, audited.",                             description: "Dark-theme tokens rewired so every page reads cleanly in low light." },
    ],
  },
  {
    month: "March 2026",
