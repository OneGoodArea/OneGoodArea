...
const SURFACES: Surface[] = [
  ...
  },
  {
    id: "bulk",
    Glyph: GlyphBulk,
    tabMethod: "POST /v1/batch",
    tabName: "Bulk scoring",
    panelName: "Bulk scoring",
    panelBody: "Score up to 100 areas in a single request, or run an entire portfolio overnight. Same engine, same version pinning, concurrency handled for you.",
    ctaLabel: "Read the batch docs",
    ctaHref: "/docs/api-reference",
    ready: true,
    codePanelHeader: "REQUEST · POST /v1/batch",
    codeLines: [
      `curl -X POST \\`,
      `  -H "Authorization: Bearer oga_..." \\`,
      `  -H "Content-Type: application/json" \\`,
      `  -d '{`,
      `    "areas": ["M1 1AE", "SW1A 1AA", "EC1A 1BB"],`,
      `    "preset": "research"`,
      `  }' \\`,
      `  "https://api.onegoodarea.com/v1/batch"`,
      ``,
      `// 200 OK — 3 scores, one engine_version stamp`,
      `// per response, ready in ~200ms.`,
    ],
  },
  {
    id: "query",
