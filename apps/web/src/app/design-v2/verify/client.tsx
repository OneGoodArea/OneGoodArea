  ...
  return (
    <div className="oga-auth-center">
      ...
      <AuthTitle
        ...
        sub="Your account is ready and writes are now unlocked. The API will accept calls signed with your key. The Developer Sandbox is free to evaluate the API and MCP server, no card required."
      />
