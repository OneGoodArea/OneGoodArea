  ...
  return (
    <main className="min-h-screen bg-[#09090b]">
      <section className="mx-auto max-w-4xl px-4 py-12">
        <h1 className="text-3xl font-bold text-[#e4e4e8] mb-2">Public Sector Workflow</h1>
        <p className="text-[#8a8a96] mb-8">
          This workflow demo is not yet configured. Signals and scores will be
          available here soon.
        </p>
        <WorkflowCard title="Signals" description="Placeholder for public sector signals">
          <p className="text-[#7a7a88] text-sm">No signals configured yet</p>
        </WorkflowCard>
        <WorkflowCard title="Scores" description="Placeholder for public sector scores" className="mt-6">
