  ...
  return (
    <main className="min-h-screen bg-[#09090b]">
      <section className="mx-auto max-w-4xl px-4 py-12">
        ...
        <WorkflowCard title="Signals" description="Placeholder for proptech signals">
          <p className="text-[#7a7a88] text-sm">No signals configured yet</p>
        </WorkflowCard>
        <WorkflowCard title="Scores" description="Placeholder for proptech scores" className="mt-6">
