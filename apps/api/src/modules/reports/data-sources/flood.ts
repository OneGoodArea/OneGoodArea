...
/* Migrated VERBATIM from legacy src/lib/data-sources/flood.ts. Changes:
   FloodRiskData + FloodWarning imported from ../inputs (canonical) instead of
   re-declared, and each res.json() is cast to a minimal boundary type (Node's
