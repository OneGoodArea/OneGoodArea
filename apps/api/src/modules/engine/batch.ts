...
/* AR-130 helpers — shared logic for the bulk scoring endpoint. Migrated
   verbatim from legacy src/lib/batch.ts (imports repointed only). Kept separate
   from the route so it can be unit-tested without HTTP context. */
