...
import { getDeprivationData, formatDeprivationForPrompt } from "@/modules/signals/data-sources/deprivation";
import type { DeprivationData } from "@/modules/signals/inputs";
